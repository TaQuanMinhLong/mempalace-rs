pub(crate) const PALACE_PROTOCOL: &str = r#"IMPORTANT — MemPalace Memory Protocol:
...
pub(crate) const AAAK_SPEC: &str = r#"AAAK is a compressed memory dialect that MemPalace uses for efficient storage.
