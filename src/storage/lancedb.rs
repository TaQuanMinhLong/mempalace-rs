...
mod tests {
    ...
    fn test_add_and_search() {
        ...
        storage
            .add_drawer(&make_drawer(
                "d3",
                "The Rust borrow checker is strict",
                "wing_code",
                "rust",
            ))
            .unwrap();
        ...
        assert!(results
            .iter()
            .all(|r| r.text.to_lowercase().contains("rust")));
    ...
    fn test_search_with_wing_filter() {
        ...
        storage
            .add_drawer(&make_drawer("d1", "Rust tutorial", "wing_code", "rust"))
            .unwrap();
        storage
            .add_drawer(&make_drawer(
                "d2",
    ...
    fn test_delete_drawer() {
        ...
        storage
            .add_drawer(&make_drawer("d1", "To be deleted", "wing_code", "rust"))
            .unwrap();
    ...
    fn test_get_drawers_by_filter() {
        ...
        storage
            ...
            .unwrap();
        storage
            .add_drawer(&make_drawer("d2", "ML tutorial", "wing_code", "ml"))
            .unwrap();
        storage
            .add_drawer(&make_drawer("d3", "Personal notes", "wing_kai", "thoughts"))
            .unwrap();
    ...
    fn test_count() {
        ...
        assert_eq!(storage.count().unwrap(), 0);
        storage
            .add_drawer(&make_drawer("d1", "doc1", "w", "r"))
            .unwrap();
        storage
            .add_drawer(&make_drawer("d2", "doc2", "w", "r"))
            .unwrap();
