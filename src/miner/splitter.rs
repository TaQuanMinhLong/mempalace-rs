...
mod tests {
    ...
    fn test_find_session_boundaries() {
        let lines = vec![
            ...
            "session 1".to_string(),
            "more".to_string(),
            "Claude Code v1.0".to_string(), // True start (no Ctrl+E nearby)
            "session 2".to_string(),
        ];
    ...
    fn test_is_true_session_start() {
        ...
        // Context restore - not a true start
    ...
    fn test_extract_subject() {
        let lines = vec![
            "> cd project".to_string(), // Skip - too short
            "> ls".to_string(),         // Skip - matches pattern
    ...
    fn test_split_file_dry_run() {
        ...
        // Content needs 10+ lines per session to pass the minimum chunk size check
        let content = "start\n\
            > prompt 1\n\
            response 1\n\
            > prompt 2\n\
