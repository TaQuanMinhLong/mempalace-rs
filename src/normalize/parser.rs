...
{"type": "event_msg", "payload": {"type": "agent_message", "message": "Hi there"}}"#;
    ...
    fn test_chatgpt_topological_sort() {
        ...
        // Minimal ChatGPT conversation export.
        // Verify that the parser can handle ChatGPT's mapping structure without panicking.
        // The root node (no "parent" key) is found and DFS traversal runs.
