...
mod tests {
    ...
    fn test_ambiguous_word_disambiguation() {
        ...
        // "grace" as concept (no context)
        let no_ctx = registry.lookup("grace", "");
        assert_eq!(no_ctx.entity_type, "person"); // registered name wins

        // "grace" in person context — person patterns score higher
    ...
    fn test_extract_unknown_candidates() {
        ...
        // Alice and Bob are not in registry, not common words
