---
description: AI-facilitated creative session using proven ideation techniques
---

# Brainstorming Workflow

Skill required: all available skills, use everything to handle the brainstorm session, this workflow requires plethora knowledge and experience
...
This document can feed directly into `/bdd-spec` to write behavior specs for the top ideas.
